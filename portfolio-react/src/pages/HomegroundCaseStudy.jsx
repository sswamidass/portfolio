...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        body: 'The subscribe page was the most considered. It had to answer the three questions every prospective subscriber has: what\'s in it, how much does it cost, how do I cancel. Clear hierarchy, honest copy, and enough warmth to make the decision feel good rather than transactional.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        image: img('/images/homeground-email-hero.png'),
      },
      {
    ...
    items: [
      {
        ...
        image: img('/images/homeground-family.jpg'),
      },
      {
