    ...
    items: [
      {
        ...
        body: 'The research was clear: the core data had value, but the path to it was too slow. Users wanted answers in one or two taps, not buried three levels deep. The web MVP needed to preserve what worked, the live data feed and status indicators, and eliminate everything that didn\'t.',
